...
def showcallregisterupdate():
    ...
    bt=Button(t,text='find',font=('arial',12,'bold'),fg='black',bg='white',width=10,bd=4,command=finddata)
    bt.place(x=50,y=100)
    ...
    e8.place(x=450,y=380)
    
    bt=Button(t,text='update',font=('arial',15,'bold'),fg='black',bg='white',bd=4,width=10,command=updatedata)
    bt.place(x=50,y=420)
    
    hd=Label(t,text='Call Register Update Form',font=('bold',25),fg='black',bg='cadetblue1')
    hd.place(x=400,y=5)
    def cancel():
        t.destroy()
    b7=Button(t,text='cancel',font=('arial',15,"bold"),fg='black',bg='white',bd=4,width=10,command=cancel)
    b7.place(x=450,y=420)
