...
def showcallregisterfind():
    ...
    hd=Label(t,text='Call Register Find Form',font=('bold',25),fg='black',bg='cadetblue1')
    hd.place(x=400,y=5)
    def cancel():
        t.destroy()
    b7=Button(t,text='cancel',font=('arial',12,"bold"),fg='black',bg='white',bd=4,width=10,command=cancel)
    b7.place(x=50,y=380)
